...
class DetectorMeta:
    ...
    marks_dims_stale: bool = (
        False  # Mechanical changes should stale subjective dimensions
    )
    subjective_dimensions: tuple[
        str, ...
    ] = ()  # Review dimensions this detector provides evidence for
