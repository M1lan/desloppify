...
DETECTORS: dict[str, DetectorMeta] = {
    ...
    "nextjs": DetectorMeta(
        ...
        "Code quality",
        "refactor",
        "fix Next.js framework smells (RSC/client boundaries, routing, middleware, env leakage)",
        needs_judgment=True,
        standalone_threshold="medium",
        tier=3,
        marks_dims_stale=True,
    ...
    "next_lint": DetectorMeta(
        ...
        "Code quality",
        "manual_fix",
        "run `next lint` and fix reported ESLint issues",
        tier=2,
        marks_dims_stale=True,
    ...
    # ── Kotlin-specific ─────────────────────────────────
    "kotlin_non_null_assertion": DetectorMeta(
        "kotlin_non_null_assertion",
        "!! overuse",
        "Code quality",
        "manual_fix",
        "reduce non-null assertion operator usage — prefer safe calls (?.) or null checks",
        needs_judgment=True,
        standalone_threshold="medium",
        tier=3,
        subjective_dimensions=("null_safety_discipline",),
    ),
    "kotlin_global_scope": DetectorMeta(
        "kotlin_global_scope",
        "GlobalScope usage",
        "Code quality",
        "manual_fix",
        "replace GlobalScope with structured concurrency (coroutineScope/viewModelScope)",
        tier=2,
        subjective_dimensions=("coroutine_architecture",),
    ),
    "kotlin_run_blocking": DetectorMeta(
        "kotlin_run_blocking",
        "runBlocking in production",
        "Code quality",
        "manual_fix",
        "remove runBlocking from production code — use suspend functions or coroutine builders",
        tier=2,
        subjective_dimensions=("coroutine_architecture",),
    ),
    "kotlin_mutable_data_class": DetectorMeta(
        "kotlin_mutable_data_class",
        "var in data class",
        "Code quality",
        "manual_fix",
        "prefer val over var in data classes for immutability",
        needs_judgment=True,
        standalone_threshold="medium",
        tier=3,
        subjective_dimensions=("design_coherence",),
    ),
    "kotlin_lateinit_misuse": DetectorMeta(
        "kotlin_lateinit_misuse",
        "lateinit var usage",
        "Code quality",
        "manual_fix",
        "prefer lazy initialization or nullable types over lateinit where possible",
        needs_judgment=True,
        standalone_threshold="medium",
        tier=3,
    ),
    "kotlin_empty_catch": DetectorMeta(
        "kotlin_empty_catch",
        "empty catch block",
        "Code quality",
        "manual_fix",
    ...
    "detekt_violation": DetectorMeta(
        ...
        "Code quality",
        "manual_fix",
        "fix detekt static analysis findings",
        tier=2,
    ),
    "ktlint_violation": DetectorMeta(
        "ktlint_violation",
        "ktlint violation",
        "Code quality",
        "auto_fix",
        "fix ktlint formatting issues — run `ktlint --format`",
